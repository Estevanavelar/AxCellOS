...
### Added
- Auto Instalador AxCell-OS Ubuntu/Debian. [@barretowiisk](https://github.com/barretowiisk)
...
- Corrigido case "Negociação" onde faltava a cor e o break no codigo em os.php e Axcell.php. [@willph](https://github.com/willph)

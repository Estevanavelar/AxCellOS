...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the axcell version in the config filename
    ...
    */
    ...
    /**
    * Get axcell current version.
    *
    * @return string Axcell current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting axcell version from GitHub!');
        }

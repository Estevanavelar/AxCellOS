...
class Produtos extends MY_Controller
{
    ...
    public function gerenciar()
    {
        ...
        $this->data['configuration']['total_rows'] = $this->estoque_model->count("produtos");

        $this->pagination->initialize($this->data['configuration']);

        $this->data['results'] = $this->estoque_model->get("produtos", "*", "", $this->data["configuration"]["per_page"], $this->uri->segment(3));
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            if ($this->estoque_model->add("produtos", $data) == true) {
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            if ($this->estoque_model->edit("produtos", $data, "idProdutos", $this->input->post("idProdutos")) == true) {
        ...
        $this->data['result'] = $this->estoque_model->getById('produtos', 'idProdutos', $this->uri->segment(3));
    ...
    public function excluir()
    {
        ...
        $this->estoque_model->delete("produtos_os", "produtos_id", $id);
        $this->estoque_model->delete("itens_de_vendas", "produtos_id", $id);
        $this->estoque_model->delete("produtos", "idProdutos", $id);

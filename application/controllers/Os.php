...
class Os extends MY_Controller
{
    ...
    public function gerenciar()
    {
        ...
        $this->data['emitente'] = $this->axcell_model->getEmitente();
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
                ...
                'senha_numerica' => $this->input->post('senha_numerica'),
                'tela_quebrada' => $this->input->post('tela_quebrada'),
                'sinal_carregador' => $this->input->post('sinal_carregador'),
                'aparelho_liga' => $this->input->post('aparelho_liga'),
                'carcaca_empenada' => $this->input->post('carcaca_empenada'),
                'bateria_inchada' => $this->input->post('bateria_inchada'),
                'alto_falante_bom' => $this->input->post('alto_falante_bom'),
                'da_sinal_vibra' => $this->input->post('da_sinal_vibra'),
            ];
            ...
            if (is_numeric($id = $this->os_model->add('os', $data, true))) {
                ...
                $emitente = $this->axcell_model->getEmitente();
                ...
                if ($this->data['configuration']['os_notification'] != 'nenhum' && $this->data['configuration']['email_automatico'] == 1) {
                    ...
                    $this->enviarOsPorEmail($idOs, $remetentes, 'Ordem de Servico Criada');
                }
    ...
    private function enviarOsPorEmail($idOs, $remetentes, $assunto)
    {
        ...
        $dados['emitente'] = $this->axcell_model->getEmitente();

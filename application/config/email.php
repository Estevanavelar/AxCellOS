...
$config['smtp_host']        = $_ENV['EMAIL_SMTP_HOST'] ?? 'mail.avelarcompany.com.br';
$config['smtp_crypto']      = $_ENV['EMAIL_SMTP_CRYPTO'] ?? ''; // tls or ssl
$config['smtp_port']        = $_ENV['EMAIL_SMTP_PORT'] ?? 587;
$config['smtp_user']        = $_ENV['EMAIL_SMTP_USER'] ?? 'contato@avelarcompany.com.br';
$config['smtp_pass']        = $_ENV['EMAIL_SMTP_PASS'] ?? '@Era158300';

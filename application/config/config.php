 ...
 * Nome do sistema
 */
$config['app_name'] = $_ENV['APP_NAME'] ?? 'AxCell-OS';
...
$config['csrf_token_name'] = $_ENV['APP_CSRF_TOKEN_NAME'] ?? 'AXCELL_TOKEN';
$config['csrf_cookie_name'] = $_ENV['APP_CSRF_COOKIE_NAME'] ?? 'AXCELL_COOKIE';
